...
struct Config: Codable, Equatable {
    ...
    var context = ""
    var translateTo = ""
    var hotkey = "Command+Shift+Space"
    var autoPaste = true
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case hotkey, autoPaste, restoreClipboard, silenceStopMs, launchAtLogin, position
        case transcriptVisible, transcriptHeight, saveHistory
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        transcriptVisible = try c.decodeIfPresent(Bool.self, forKey: .transcriptVisible) ?? d.transcriptVisible
        transcriptHeight = try c.decodeIfPresent(Double.self, forKey: .transcriptHeight) ?? d.transcriptHeight
