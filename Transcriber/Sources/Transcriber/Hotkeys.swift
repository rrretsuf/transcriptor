...
final class Hotkeys {
    ...
    static func parseTap(_ hotkey: String) -> (modifier: String, count: Int)? {
    ...
    static func parseAccelerator(_ accelerator: String) -> Parsed? {
    ...
    private func installHandlerIfNeeded() {
        ...
        InstallEventHandler(GetApplicationEventTarget(), { _, event, _ in
            ...
            GetEventParameter(event, UInt32(kEventParamDirectObject), typeEventHotKeyID, nil,
